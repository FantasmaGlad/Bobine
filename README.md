...
| ![Android](https://img.shields.io/badge/Android-3DDC84?style=flat-square&logo=android&logoColor=white) | <sub>`.apk`<br>*(Package)*</sub> | <sub>ARM64</sub> | <sub>*Coming soon...*</sub> | **Android Tablets & ARM Touch Kiosks**<br><sub>• Wired USB-C DisplayPort video output (Xiaomi Pad 6/7/8, Galaxy Tab)</sub><br><sub>• Real FastAPI backend running on-device via Chaquopy, validated on emulator</sub><br><sub>• In active development — dual-display and background persistence not yet implemented</sub> |
