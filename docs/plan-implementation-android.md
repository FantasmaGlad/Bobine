...
### E. Annulation Réactive (Croix ✕), Télémétrie Temps Réel (ETA) et Politique "Maxi Premium"
...
- **Correctif** :
  ...
  - Politique stricte "Maxi Premium" : aucun downscale des vidéos 2K ou 4K, application d'un bitrate adaptatif élevé (28M en 4K, 14M en 2K, 6M en 1080p).
...
- [x] 16sexies — annulation réactive FFmpeg (croix ✕), estimation ETA en direct, conservation 2K/4K Maxi Premium et encodeurs matériels multi-OS
