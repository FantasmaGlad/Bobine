...
- **Windows/macOS et détection d'écran câblé** : sujet distinct, déjà tranché séparément (cf. `AGENTS.md` §3, décision du 2026-09-17) — statu quo volontaire, non lié à ce CDC.
