...
| ![Android](https://img.shields.io/badge/Android-3DDC84?style=flat-square&logo=android&logoColor=white) | <sub>`.apk`<br>*(Paquet)*</sub> | <sub>ARM64</sub> | <sub>*Prochainement...*</sub> | **Tablettes & Bornes Tactiles ARM**<br><sub>• Sortie vidéo filaire USB-C (DisplayPort / HDMI)</sub><br><sub>• Pupitre coach tactile & régie vidéo autonome</sub><br><sub>• Prochainement... (en cours de développement)</sub> |
| [![bobine.fit](https://img.shields.io/badge/bobine.fit-4285F4?style=flat-square&logo=googlechrome&logoColor=white)](https://bobine.fit) | <sub>Portail Web</sub> | <sub>Universel</sub> | [**Visiter bobine.fit**](https://bobine.fit) | **Site Officiel & Documentation**<br><sub>• Guides de démarrage, actualités & notes de version</sub><br><sub>• Documentation interactive & télécommande web</sub> |
