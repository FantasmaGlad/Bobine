...
| ![Android](https://img.shields.io/badge/Android-3DDC84?style=flat-square&logo=android&logoColor=white) | <sub>`.apk`<br>*(Paquet)*</sub> | <sub>ARM64</sub> | <sub>*Prochainement...*</sub> | **Tablettes Android & Bornes Tactiles ARM**<br><sub>• Sortie vidéo filaire USB-C DisplayPort (Xiaomi Pad 6/7/8, Galaxy Tab)</sub><br><sub>• Vrai backend FastAPI embarqué via Chaquopy, validé sur émulateur</sub><br><sub>• En développement actif — double affichage et persistance en arrière-plan pas encore implémentés</sub> |
...
| :--- | :---: | :---: | :--- | :--- |
| <img src="Assets/Images/bash.svg" width="20" height="20" valign="middle" alt="Bash"> **Installateur Bash (CLI)** | <sub>Script Shell</sub> | <sub>Debian 13 (Mini PC)</sub> | <sub>`curl -sSL https://bobine.fit/install.sh \| bash`</sub> | <sub>• Séquence automatisée en 15 étapes</sub><br><sub>• Décodage matériel VA-API 4K (&lt; 8% CPU)</sub><br><sub>• Allumage/veille TV par HDMI-CEC</sub><br><sub>• Kiosque X11 plein écran sans veille</sub><br><sub>• Services systemd auto-réparateurs</sub> |
