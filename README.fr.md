...
[![Version : v3.0.5](https://img.shields.io/badge/Release-v3.0.5-brightgreen)](https://github.com/FantasmaGlad/Bobine/releases/latest)
...
| ![Windows 11](https://img.shields.io/badge/Windows_11-0078D4?style=flat-square&logo=windows11&logoColor=white) | <sub>`.exe`<br>*(Installeur)*</sub> | <sub>x86-64</sub> | <sub>[**Télécharger Bobine-Setup-3.0.5.exe**](https://github.com/FantasmaGlad/Bobine/releases/download/V3.0.5/Bobine-Setup-3.0.5.exe)</sub> | **PC de Bureau & Ordinateurs Portables Windows**<br><sub>• Installation guidée en 1 clic avec raccourci sur le Bureau</sub><br><sub>• Démarrage discret près de l'horloge (icône systray en arrière-plan)</sub><br><sub>• Mode capot fermé (clamshell) : branchez le portable en HDMI à la télé et fermez-le sans mise en veille</sub><br><sub>• Télécommande mobile instantanée via QR code pour piloter la musique et les cours</sub> |
| ![Debian](https://img.shields.io/badge/Debian-A81D33?style=flat-square&logo=debian&logoColor=white) ![Ubuntu](https://img.shields.io/badge/Ubuntu-E95420?style=flat-square&logo=ubuntu&logoColor=white) ![Linux Mint](https://img.shields.io/badge/Linux%20Mint-87CF3E?style=flat-square&logo=linuxmint&logoColor=white) | <sub>`.deb`<br>*(Paquet & Dépôt)*</sub> | <sub>x86-64<br>*(amd64)*</sub> | <sub>[**Dépôt APT apt.bobine.fit**](https://apt.bobine.fit)<br>[**bobine_3.0.5_amd64.deb**](https://github.com/FantasmaGlad/Bobine/releases/download/V3.0.5/bobine_3.0.5_amd64.deb)</sub> | **Postes Linux de Bureau & PC Reconditionnés**<br><sub>• Paquet officiel `.deb` et disponible sur la Logithèque Ubuntu App Center</sub><br><sub>• Mises à jour fluides en 1 clic via le dépôt officiel `apt.bobine.fit`</sub><br><sub>• Idéal pour recycler un ancien PC de bureau en borne fitness autonome</sub><br><sub>• Intégration bureau complète : raccourci d'application et zone de notification</sub> |
...
1. **Téléchargez** [**`Bobine-3.0.5.apk`**](https://github.com/FantasmaGlad/Bobine/releases/download/V3.0.5/Bobine-3.0.5.apk) directement sur votre tablette (ou transférez le fichier via câble USB).
...
1. **Téléchargez** [**`Bobine-Setup-3.0.5.exe`**](https://github.com/FantasmaGlad/Bobine/releases/download/V3.0.5/Bobine-Setup-3.0.5.exe) (ou depuis la [dernière release GitHub](https://github.com/FantasmaGlad/Bobine/releases/latest)).
...
1. **Téléchargez** [**`bobine_3.0.5_amd64.deb`**](https://github.com/FantasmaGlad/Bobine/releases/download/V3.0.5/bobine_3.0.5_amd64.deb) (ou depuis la [dernière release GitHub](https://github.com/FantasmaGlad/Bobine/releases/latest)).
...
1. **Téléchargez** [**`Bobine-3.0.5.dmg`**](https://github.com/FantasmaGlad/Bobine/releases/download/V3.0.5/Bobine-3.0.5.dmg) (ou depuis la [dernière release GitHub](https://github.com/FantasmaGlad/Bobine/releases/latest)).
